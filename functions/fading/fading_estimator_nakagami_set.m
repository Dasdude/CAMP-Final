function [params,bin_start_edges,approximated_per,loss_values] = fading_estimator_nakagami_set(fading_linear_cell,init_param,d_min,per_stat,truncation_value,min_samples,max_window_size,file_name,show_dist,min_samples_per_cell)
